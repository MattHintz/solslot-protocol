...
FROZEN_CHECKSUM: Optional[str] = (
    ...
    #     a reserve-acquisition seller price cap at deed NAV.
    #   - pool_singleton_inner.clsp now curries MIN_NAV_REGISTRY_VERSION and
    #     rejects stale V2 NAV evidence below the deployment freshness floor.
    #   - pool_singleton_inner.clsp V1 dispatch now uses nth-based param
    #     extraction to avoid brittle deep f/r selectors.
    #   - pool_singleton_inner.clsp emits same-coin CAT authorization
    #     announcements alongside pool puzzle announcements.
    #   - pool_token_tail.clsp rederives the trusted pool singleton full puzzle
    #     hash from its curried launcher identity and requires both pool puzzle
    #     and pool coin announcements for mint/melt.
    ...
    #     shape and unpacks the Solslot mint/melt authorization payload from
