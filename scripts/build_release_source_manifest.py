#!/usr/bin/env python3
"""Build the deterministic nine-repository RC27.36 source manifest."""
...
RELEASE_ID = "solslot-v2-alpha-rc27.36-20260824"
...
def build_manifest(
    ...
    *,
    ...
    if release_id != RELEASE_ID:
        raise ValueError("release_id must identify the coordinated RC27.36 alpha release")
    expected_branch = (
